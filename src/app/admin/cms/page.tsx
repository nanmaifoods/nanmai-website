    ...
    fields: [
      {
        ...
        label: "Hero Title",
        type: "text",
        value: "Simply Crispy. Simply Tasty.",
      },
      {
        key: "hero_subtitle",
        label: "Hero Subtitle",
        type: "text",
        value:
          "Premium quality traditional South Indian appalams, crafted with love.",
      },
      {
        key: "hero_badge",
      ...
      {
        key: "cta_offer_text",
        label: "CTA Offer Code",
        type: "text",
        value: "NANMAI50",
      },
      {
        key: "cta_offer_title",
        label: "CTA Offer Title",
        type: "text",
        value: "Get ₹50 OFF Your First Order",
      },
    ],
  },
  about: {
    ...
    fields: [
      {
        ...
        label: "Hero Headline",
        type: "text",
        value: "15 Years of Pure Crunch",
      },
      {
        key: "mission_title",
        label: "Mission Title",
        type: "text",
        value: "Bringing Authentic Taste to Every Table",
      },
      {
        key: "mission_body",
        ...
        type: "textarea",
        value:
          "At Nanmai Appalam, we believe that food is more than sustenance — it's memory, culture, and connection.",
      },
    ],
  },
  contact: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "textarea",
        value:
          "Apple Infinite Solutions No,418 2nd main road, Prakash Nagar, Thirunindravur, Tiruvallur, Chennai - 602024",
      },
      {
        key: "hours_weekday",
        label: "Weekday Hours",
    ...
    fields: [
      {
        ...
        label: "Instagram URL",
        type: "text",
        value: "https://instagram.com/nanmaiappalam",
      },
      {
        key: "facebook",
        label: "Facebook URL",
        type: "text",
        value: "https://facebook.com/nanmaiappalam",
      },
      {
        key: "youtube",
        label: "YouTube URL",
        type: "text",
        value: "https://youtube.com/nanmaiappalam",
      },
      {
        key: "whatsapp",
    ...
    fields: [
      {
        ...
        label: "Site Title",
        type: "text",
        value: "Nanmai Appalam – Pure & Crispy Traditional Papads",
      },
      {
        key: "meta_description",
        label: "Meta Description",
        type: "textarea",
        value: "Shop premium quality traditional South Indian papads online.",
      },
      {
        key: "og_description",
        ...
        type: "textarea",
        value:
          "Crispy, tasty, made with superior ingredients. Order online for home delivery.",
      },
    ],
  },
};
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-brand-green/10 border border-brand-green/20 rounded-2xl px-5 py-3 flex items-center gap-3 text-sm text-brand-green">
        <Globe size={16} />
        <span>
          Changes saved here update the live website content automatically.
        </span>
        <Link
          href="/"
          target="_blank"
