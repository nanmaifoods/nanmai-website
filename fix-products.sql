-- ============================================================
-- NANMAI APPALAM – Reset & Seed All 17 Products
...
-- Step 2: Update category constraint if needed
...
SELECT id, name, slug, price, weight, category, is_active, is_featured FROM products ORDER BY price DESC;
